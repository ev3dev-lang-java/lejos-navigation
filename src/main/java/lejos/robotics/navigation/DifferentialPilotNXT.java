 ...
 * 
 **/
public class DifferentialPilotNXT implements RegulatedMotorListener, ArcRotateMoveController {
	/**
	 ...
	 */
	public DifferentialPilotNXT(final double wheelDiameter,
	 ...
	 *            running backward.
	 */
	public DifferentialPilotNXT(final double leftWheelDiameter,
